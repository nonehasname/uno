...
public class HandController : MonoBehaviour
{
    ...
    public void SelectCard(Transform newSelectedCard){

        if (selectedCard != null){
            //move back previously selected card
            Vector3 oldSelectedPosition = selectedCard.localPosition;
            oldSelectedPosition.y = 0.0f;
            selectedCard.localPosition = oldSelectedPosition;
         }
        ...
        Vector3 newSelectedPosition = selectedCard.localPosition;
        newSelectedPosition.y = cardHeight / 2.0f;
        selectedCard.localPosition = newSelectedPosition;
    ...
    public void PlayCard(){ 
        if (selectedCard != null){
            ...
            Destroy(selectedCard.gameObject); //hand is only tracked by the objects - will need to do more when we have more of a hand
            selectedCard = null;
            UpdateCardSpacing();
        }
    }
